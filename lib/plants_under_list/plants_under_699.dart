...
class PlantsUnder699Page extends StatefulWidget {
  const PlantsUnder699Page({Key? key}) : super(key: key);

  @override
  State<PlantsUnder699Page> createState() => _PlantsUnder699PageState();
}

class _PlantsUnder699PageState extends State<PlantsUnder699Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnder699PageScreen(),
    );
  }
}

class PlantsUnder699PageScreen extends StatelessWidget {
  const PlantsUnder699PageScreen({Key? key}) : super(key: key);
    ...
    return CustomScrollView(
      slivers: [
        ...
        StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("items")
              .where("price", isLessThanOrEqualTo: 699)
              .limit(1)
              .snapshots(),
