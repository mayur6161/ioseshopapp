...
class PlantsUnderHighPricePage extends StatefulWidget {
  const PlantsUnderHighPricePage({Key? key}) : super(key: key);

  @override
  State<PlantsUnderHighPricePage> createState() => _PlantsUnderHighPricePageState();
}

class _PlantsUnderHighPricePageState extends State<PlantsUnderHighPricePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnderHighPricePageScreen(),
    );
  }
}

class PlantsUnderHighPricePageScreen extends StatelessWidget {
  const PlantsUnderHighPricePageScreen({Key? key}) : super(key: key);
