...
class PlantsUnder499Page extends StatefulWidget {
  const PlantsUnder499Page({Key? key}) : super(key: key);

  @override
  State<PlantsUnder499Page> createState() => _PlantsUnder499PageState();
}

class _PlantsUnder499PageState extends State<PlantsUnder499Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnder499PageScreen(),
    );
  }
}

class PlantsUnder499PageScreen extends StatelessWidget {
  const PlantsUnder499PageScreen({Key? key}) : super(key: key);
    ...
    return CustomScrollView(
      slivers: [
        ...
        StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("items")
              .where("price", isLessThanOrEqualTo: 499)
              .limit(1)
              .snapshots(),
