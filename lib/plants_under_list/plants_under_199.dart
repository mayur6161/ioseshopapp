...
class PlantsUnder199Page extends StatefulWidget {
  const PlantsUnder199Page({Key? key}) : super(key: key);

  @override
  State<PlantsUnder199Page> createState() => _PlantsUnder199PageState();
}

class _PlantsUnder199PageState extends State<PlantsUnder199Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnder199PageScreen(),
    );
  }
}

class PlantsUnder199PageScreen extends StatelessWidget {
  const PlantsUnder199PageScreen({Key? key}) : super(key: key);
