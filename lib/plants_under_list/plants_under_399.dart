...
class PlantsUnder399Page extends StatefulWidget {
  const PlantsUnder399Page({Key? key}) : super(key: key);

  @override
  State<PlantsUnder399Page> createState() => _PlantsUnder399PageState();
}

class _PlantsUnder399PageState extends State<PlantsUnder399Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnder399PageScreen(),
    );
  }
}

class PlantsUnder399PageScreen extends StatelessWidget {
  const PlantsUnder399PageScreen({Key? key}) : super(key: key);
    ...
    return CustomScrollView(
      slivers: [
        ...
        StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("items")
              .where("price", isLessThanOrEqualTo: 399)
              .limit(1)
              .snapshots(),
