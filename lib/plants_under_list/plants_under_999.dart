...
class PlantsUnder999Page extends StatefulWidget {
  const PlantsUnder999Page({Key? key}) : super(key: key);

  @override
  State<PlantsUnder999Page> createState() => _PlantsUnder999PageState();
}

class _PlantsUnder999PageState extends State<PlantsUnder999Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantsUnder999PageScreen(),
    );
  }
}

class PlantsUnder999PageScreen extends StatelessWidget {
  const PlantsUnder999PageScreen({Key? key}) : super(key: key);
    ...
    return CustomScrollView(
      slivers: [
        ...
        StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("items")
              .where("price", isLessThanOrEqualTo: 999)
              .limit(1)
              .snapshots(),
