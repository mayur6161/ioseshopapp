...
class AddProductScreenCatergory extends StatelessWidget {
  const AddProductScreenCatergory({Key? key}) : super(key: key);
...
// class AddProductScreenCatergory extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const AddProductScreenCatergory(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<AddProductScreenCatergory> createState() => _AddProductScreenCategoryState();
// }
//
// class _AddProductScreenCategoryState extends State<AddProductScreenCatergory> {
...
//           title: Text(
//             widget.editOrAdd == "Add" ? "Add Product" : "Update Product",
//             style: TextStyle(
...
//                     .collection("items_category")//changed one
...
//               "items_category/${_titleTextEditingController.text + i.toString()}"); //changed two
//
...
//     final itemsRef =
//         FirebaseFirestore.instance.collection("items_category").doc(widget.productId); //changed three
//     itemsRef.update({
...
//     final itemsRef = FirebaseFirestore.instance.collection("items_category"); // changed four
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
