...
class ExtraItemDisplayScreen extends StatelessWidget {
  // const ExtraItemDisplayScreen({Key? key}) : super(key: key);
...
//
// class ExtraItemDisplayScreen extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const ExtraItemDisplayScreen(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<ExtraItemDisplayScreen> createState() => _ExtraItemDisplayScreenState();
// }
//
// class _ExtraItemDisplayScreenState extends State<ExtraItemDisplayScreen> {
...
//           title: Text(
//             widget.editOrAdd == "Add" ? "ExtraItemDisplay Add Product" : "ExtraItemDisplay Update Product",
//             style: TextStyle(
...
//               "ExtraItemDisplay/${_titleTextEditingController.text + i.toString()}");
//
...
//     final itemsRef = FirebaseFirestore.instance.collection("ExtraItemDisplay");
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
