...
class ProductForHomeScreen extends StatelessWidget {
...
// class ProductForHomeScreen extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const ProductForHomeScreen(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<ProductForHomeScreen> createState() => _ProductForHomeScreenState();
// }
//
// class _ProductForHomeScreenState extends State<ProductForHomeScreen> {
...
//                 ? "Product For Home Add Product"
//                 : "Product For Home Update Product",
//             style: TextStyle(
...
//               "ProductForHome/${_titleTextEditingController.text + i.toString()}");
//
...
//     final itemsRef = FirebaseFirestore.instance.collection("ProductForHome");
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
