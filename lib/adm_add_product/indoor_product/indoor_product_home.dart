...
class IndoorProductScreenAdmin extends StatelessWidget {
  // const IndoorProductScreenAdmin({Key? key}) : super(key: key);
...
// class IndoorProductScreenAdmin extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const IndoorProductScreenAdmin(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<IndoorProductScreenAdmin> createState() =>
//       _IndoorProductScreenAdminState();
// }
//
// class _IndoorProductScreenAdminState extends State<IndoorProductScreenAdmin> {
...
//                 ? "IndoorProduct Add Product"
//                 : "IndoorProduct Update Product",
...
//               "IndoorProduct/${_titleTextEditingController.text + i.toString()}");
//
...
//     final itemsRef = FirebaseFirestore.instance.collection("IndoorProduct");
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
