...
class ProductForApartmentScreen extends StatelessWidget {
  // const ProductForApartmentScreen({Key? key}) : super(key: key);
...
// class ProductForApartmentScreen extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const ProductForApartmentScreen(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<ProductForApartmentScreen> createState() => _ProductForApartmentScreenState();
// }
//
// class _ProductForApartmentScreenState extends State<ProductForApartmentScreen> {
...
//           title: Text(
//             widget.editOrAdd == "Add" ? "Product For apartment Add Product" : "Product For Apartment Update Product",
//             style: TextStyle(
...
//               "ProductForApartment/${_titleTextEditingController.text + i.toString()}");
//
...
//     final itemsRef = FirebaseFirestore.instance.collection("ProductForApartment");
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
