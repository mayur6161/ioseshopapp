...
class _DeliveryDetailsScreenState extends State<DeliveryDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            widget.editOrAdd == "Add" ? "DeliveryDetailsScreen Add Product" : "DeliveryDetailsScreen Update Product",
            style: TextStyle(
      ...
      try {
        for (int i = 0; i < _imageFileList!.length; i++) {
          final Reference storageReference = storage.ref().child(
              "DeliveryDetails/${_titleTextEditingController.text + i.toString()}");
  ...
  saveItemInfo(List<String> downloadUrl) {
    final itemsRef = FirebaseFirestore.instance.collection("DeliveryDetails");
    itemsRef.add({
      "shortInfo": _shortInfoTextEditingController.text.trim(),
      "longDescription": _descriptionTextEditingController.text.trim(),
      "price": int.parse(_priceTextEditingController.text),
