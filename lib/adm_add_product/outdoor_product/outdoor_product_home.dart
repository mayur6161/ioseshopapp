...
class OutdoorProductScreenAdmin extends StatelessWidget {
  // const OutdoorProductScreenAdmin({Key? key}) : super(key: key);
...
//
//
// class OutdoorProductScreenAdmin extends StatefulWidget {
//   final String editOrAdd;
//   final String productId;
//
//   const OutdoorProductScreenAdmin(
//       {Key? key, required this.editOrAdd, required this.productId})
//       : super(key: key);
//
//   @override
//   State<OutdoorProductScreenAdmin> createState() =>
//       _OutdoorProductScreenAdminState();
// }
//
// class _OutdoorProductScreenAdminState extends State<OutdoorProductScreenAdmin> {
...
//                 ? "OutdoorProduct Add Product"
//                 : "OutdoorProduct Update Product",
...
//               "OutdoorProduct/${_titleTextEditingController.text + i.toString()}");
//
...
//     final itemsRef = FirebaseFirestore.instance.collection("OutdoorProduct");
//     itemsRef.add({
//       "shortInfo": _shortInfoTextEditingController.text.trim(),
//       "longDescription": _descriptionTextEditingController.text.trim(),
//       "price": int.parse(_priceTextEditingController.text),
