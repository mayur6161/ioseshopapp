...
class PageTwoProducts extends StatefulWidget {
  const PageTwoProducts({Key? key}) : super(key: key);

  @override
  State<PageTwoProducts> createState() => _PageTwoProductsState();
}

class _PageTwoProductsState extends State<PageTwoProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PageTwoProductsScreen(),
    );
  }
}

class PageTwoProductsScreen extends StatelessWidget {
  const PageTwoProductsScreen({Key? key}) : super(key: key);
