...
class PageOneProducts extends StatefulWidget {
  const PageOneProducts({Key? key}) : super(key: key);

  @override
  State<PageOneProducts> createState() => _PageOneProductsState();
}

class _PageOneProductsState extends State<PageOneProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PageOneProductsScreen(),
    );
  }
}

class PageOneProductsScreen extends StatelessWidget {
  const PageOneProductsScreen({Key? key}) : super(key: key);
