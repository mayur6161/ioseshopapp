...
class PageFourProducts extends StatefulWidget {
  const PageFourProducts({Key? key}) : super(key: key);

  @override
  State<PageFourProducts> createState() => _PageFourProductsState();
}

class _PageFourProductsState extends State<PageFourProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PageFourProductsScreen(),
    );
  }
}

class PageFourProductsScreen extends StatelessWidget {
  const PageFourProductsScreen({Key? key}) : super(key: key);
