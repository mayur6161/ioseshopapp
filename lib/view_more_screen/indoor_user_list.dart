...
class IndoorPlantUserList extends StatefulWidget {
  const IndoorPlantUserList({Key? key}) : super(key: key);

  @override
  State<IndoorPlantUserList> createState() => _IndoorPlantUserListState();
}

class _IndoorPlantUserListState extends State<IndoorPlantUserList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const IndoorPlantUserList2(),
    );
  }
}

class IndoorPlantUserList2 extends StatelessWidget {
  const IndoorPlantUserList2({Key? key}) : super(key: key);
