...
class PlantContainers extends StatefulWidget {
  const PlantContainers({Key? key}) : super(key: key);

  @override
  State<PlantContainers> createState() => _PlantContainersState();
}

class _PlantContainersState extends State<PlantContainers> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const PlantContainers2(),
    );
  }
}

class PlantContainers2 extends StatelessWidget {
  const PlantContainers2({Key? key}) : super(key: key);
