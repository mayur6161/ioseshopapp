...
class TablePlantUserList extends StatefulWidget {
  const TablePlantUserList({Key? key}) : super(key: key);

  @override
  State<TablePlantUserList> createState() => _TablePlantUserListState();
}

class _TablePlantUserListState extends State<TablePlantUserList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const TablePlantUserList2(),
    );
  }
}

class TablePlantUserList2 extends StatelessWidget {
  const TablePlantUserList2({Key? key}) : super(key: key);
