...
class SeeAllPlants extends StatefulWidget {
  const SeeAllPlants({Key? key}) : super(key: key);

  @override
  State<SeeAllPlants> createState() => _SeeAllPlantsState();
}

class _SeeAllPlantsState extends State<SeeAllPlants> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const SeeAllPlants2(),
    );
  }
}

class SeeAllPlants2 extends StatelessWidget {
  const SeeAllPlants2({Key? key}) : super(key: key);
