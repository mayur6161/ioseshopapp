...
class OutdoorPlantUserList extends StatefulWidget {
  const OutdoorPlantUserList({Key? key}) : super(key: key);

  @override
  State<OutdoorPlantUserList> createState() => _OutdoorPlantUserListState();
}

class _OutdoorPlantUserListState extends State<OutdoorPlantUserList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const OutdoorPlantUserList2(),
    );
  }
}

class OutdoorPlantUserList2 extends StatelessWidget {
  const OutdoorPlantUserList2({Key? key}) : super(key: key);
