...
class NewInListUserPage extends StatefulWidget {
  const NewInListUserPage({Key? key}) : super(key: key);

  @override
  State<NewInListUserPage> createState() => _NewInListUserPageState();
}

class _NewInListUserPageState extends State<NewInListUserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const NewInListUserPageScreen(),
    );
  }
}

class NewInListUserPageScreen extends StatelessWidget {
  const NewInListUserPageScreen({Key? key}) : super(key: key);
